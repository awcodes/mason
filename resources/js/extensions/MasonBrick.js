        ...
        return ({ node }) => {
            ...
            const controls = `
                <div x-data="{disabled: true}" x-on:click="disabled = false" x-on:click.away="disabled = true">
                    <div class="mason-brick-controls" x-show="!disabled" x-cloak>
                        <button type="button" x-bind:disabled="disabled" x-on:click="handleBlockUpdate('${node.attrs.identifier}', JSON.parse(decodeURIComponent('${data}')))">
